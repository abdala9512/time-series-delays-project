...
# TALLER GRUPAL 3 ---------------------------------------------------------
#  Miguel Arquez Abdala, Andres Felipe Cardona Rodriguez, Leonardo Restrepo Alvarez,
# Aplicación de Modelos de Analítica para la Identificación de Absentismos de Citas Médicas
# -------------------------------------------------------------------------
...
decisionTree <- rpart(
  ...
  data    = train,
  method  = "class",
  control = list(minbucket=18, cp = 0.01, minsplit = 5, maxdepth = 4, xval = 10)
)
...
basemodelCM <- conf_matrix$byClass[,'F1']
basemodelCM
...
calculateChallengeMetric(basemodelCM)
